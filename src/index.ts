...
server.tool(
  "get-subjects",
  "Retrieve the course information from the ZEN University syllabus. If neither the numeric expected year of enrollment (enrollment_grade) nor the freeword search parameter (freeword) is specified, all course information will be retrieved.",
  {
